...
export class Program extends DiagnosticEmitter {
  ...
  initialize(): void {
    ...
    // set up global aliases
    {
      ...
      if (!globalAliases.has(CommonNames.emit_buffer_size)) {
        globalAliases.set(CommonNames.emit_buffer_size, BuiltinNames.emit_buffer_size);
      }
      ...
      if (!globalAliases.has(CommonNames.ledger_last_time)) {
        globalAliases.set(CommonNames.ledger_last_time, BuiltinNames.ledger_last_time);
      }
      ...
      if (!globalAliases.has(CommonNames.state_foreign_set)) {
        globalAliases.set(CommonNames.state_foreign_set, BuiltinNames.state_foreign_set);
      }
      ...
      if (!globalAliases.has(CommonNames.data_size)) {
        globalAliases.set(CommonNames.data_size, BuiltinNames.data_size);
      }
