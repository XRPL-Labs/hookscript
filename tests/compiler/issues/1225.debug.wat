(module
 ...
 (func $issues/1225/X#set:normal (type $i32_i32_=>_none) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store $0
 )
 ...
 (func $issues/1225/X#set:x (type $i32_i32_=>_none) (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store $0 offset=8
 )
 (func $issues/1225/normal (type $none_=>_i32) (result i32)
  global.get $issues/1225/x
  i32.load $0
 )
 (func $issues/1225/viaThis (type $none_=>_i32) (result i32)
  global.get $issues/1225/x
  i32.load $0 offset=4
 )
 ...
 (func $start:issues/1225 (type $none_=>_none)
  memory.size $0
  i32.const 16
  i32.shl
  global.get $~lib/memory/__heap_base
 ...
 (func $issues/1225/X#constructor (type $i32_i32_=>_i32) (param $this i32) (param $x i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
