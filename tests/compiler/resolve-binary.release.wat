(module
 ...
 (data (i32.const 7180) "\1c\00\00\00\01\00\00\00\02")
 (data (i32.const 7200) "lt")
 (data (i32.const 7212) "\1c\00\00\00\01\00\00\00\02")
 (data (i32.const 7232) "gt")
 (data (i32.const 7244) "\1c\00\00\00\01\00\00\00\02")
 (data (i32.const 7264) "le")
 (data (i32.const 7276) "\1c\00\00\00\01\00\00\00\02")
 (data (i32.const 7296) "ge")
 (data (i32.const 7308) "\1c\00\00\00\01\00\00\00\02")
 (data (i32.const 7328) "eq")
 (data (i32.const 7340) "\1c\00\00\00\01\00\00\00\02")
 (data (i32.const 7360) "ne")
 (data (i32.const 7372) "\1c\00\00\00\01\00\00\00\03")
 (data (i32.const 7392) "add")
 (data (i32.const 7404) "\1c\00\00\00\01\00\00\00\03")
 (data (i32.const 7424) "sub")
 (data (i32.const 7436) "\1c\00\00\00\01\00\00\00\03")
 (data (i32.const 7456) "mul")
 (data (i32.const 7468) "\1c\00\00\00\01\00\00\00\03")
 (data (i32.const 7488) "div")
 (data (i32.const 7500) "\1c\00\00\00\01\00\00\00\03")
 (data (i32.const 7520) "rem")
 (data (i32.const 7532) "\1c\00\00\00\01\00\00\00\03")
 (data (i32.const 7552) "pow")
