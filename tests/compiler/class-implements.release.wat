(module
 ...
 (data (i32.const 1232) "\0b\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1260) " \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00\06\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00 \00\00\00\07\00\00\00 \00\00\00\07")
 ...
 (func $~start (type $none_=>_none)
  ...
  block $__inlined_func$class-implements/D#foo@virtual (result i32)
   global.get $~lib/memory/__stack_pointer
   global.get $class-implements/d
   local.tee $0
   i32.store $0 offset=8
   ...
   i32.const 10
   i32.eq
   br_if $__inlined_func$class-implements/D#foo@virtual
   drop
   i32.const 3
  end
  i32.const 3
  ...
  block $__inlined_func$class-implements/D#foo@virtual9 (result i32)
   global.get $~lib/memory/__stack_pointer
   global.get $class-implements/e
   local.tee $0
   i32.store $0 offset=8
   ...
   i32.const 10
   i32.eq
   br_if $__inlined_func$class-implements/D#foo@virtual9
   drop
   i32.const 3
  end
  i32.const 3
