(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 348))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33116))
 (global $~lib/memory/__heap_base i32 (i32.const 33116))
 (memory $0 1)
 ...
 (data (i32.const 204) ",\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\0f\00\00\00unexpected null\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data (i32.const 252) ",\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\13\00\00\00unexpected downcast\00\00\00\00\00\00\00\00\00")
 (data (i32.const 304) "\05\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00 \00\00\00\04\00\00\00 \00\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $managed-cast/Animal#tame (type $i32_=>_none) (param $this i32)
  nop
 )
 (func $managed-cast/testUpcast (type $i32_=>_none) (param $cat i32)
  local.get $cat
  call $managed-cast/Animal#tame
 )
 (func $managed-cast/testUpcastToNullable (type $i32_=>_none) (param $cat i32)
 ...
 (func $managed-cast/testUpcastFromToNullable (type $i32_=>_none) (param $cat i32)
  (local $maybeAnimal i32)
  local.get $cat
  local.set $maybeAnimal
  local.get $maybeAnimal
 ...
 (func $managed-cast/testDowncastToNullable (type $i32_=>_none) (param $animal i32)
  (local $1 i32)
  (local $maybeCat i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $managed-cast/testDowncastFromToNullable (type $i32_=>_none) (param $animal i32)
  (local $1 i32)
  (local $maybeCat i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $managed-cast/testUpcastFromNullable (type $i32_=>_none) (param $cat i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $managed-cast/testDowncast (type $i32_=>_none) (param $animal i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $managed-cast/testDowncastFromNullable (type $i32_=>_none) (param $animal i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
