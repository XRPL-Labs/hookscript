(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 308))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33076))
 (global $~lib/memory/__heap_base i32 (i32.const 33076))
 (memory $0 1)
 ...
 (data (i32.const 256) "\06\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\02\t\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $class/GenericInitializer<i32>~visit (type $i32_i32_=>_none) (param $0 i32) (param $1 i32)
  (local $2 i32)
  local.get $0
  i32.load $0
  local.tee $2
 ...
 (func $export:class/test (type $i32_=>_i32) (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
