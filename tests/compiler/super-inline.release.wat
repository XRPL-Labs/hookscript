(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34044))
 (memory $0 1)
 (data (i32.const 1036) ",")
 ...
 (data (i32.const 1232) "\05\00\00\00 \00\00\00\00\00\00\00 ")
 ...
 (func $super-inline/Foo#constructor (type $i32_=>_i32) (param $0 i32) (result i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
