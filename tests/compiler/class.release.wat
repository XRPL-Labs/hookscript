(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 34100))
 (memory $0 1)
 (data (i32.const 1036) ",")
 ...
 (data (i32.const 1280) "\06\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1308) " ")
     ...
     block $class/Animal<f64>
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        ...
        i32.sub
        i32.load $0
        br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $class/Animal<f64> $folding-inner0 $~lib/array/Array<i32> $invalid
       end
       return
      end
      return
