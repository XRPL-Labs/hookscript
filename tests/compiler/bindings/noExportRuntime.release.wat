(module
 ...
 (global $bindings/noExportRuntime/isArrayOfBasic i32 (i32.const 1360))
 (global $bindings/noExportRuntime/isArrayOfArray i32 (i32.const 1440))
 ...
 (data (i32.const 1068) ",")
 (data (i32.const 1080) "\01\00\00\00\0e\00\00\00Invalid length")
 (data (i32.const 1116) ",")
 ...
 (data (i32.const 1340) ",")
 (data (i32.const 1352) "\04\00\00\00\10\00\00\000\05\00\000\05")
 (data (i32.const 1388) "\1c")
 (data (i32.const 1420) ",")
 (data (i32.const 1432) "\05\00\00\00\10\00\00\00\80\05\00\00\80\05")
 (data (i32.const 1472) "\07\00\00\00 \00\00\00\00\00\00\00 ")
 (data (i32.const 1500) "\01\t\00\00\02\00\00\00\02\t\00\00\00\00\00\00\02A\00\00\00\00\00\00 ")
      ...
      block $~lib/array/Array<~lib/array/Array<i32>>
       block $~lib/string/String
        block $~lib/arraybuffer/ArrayBuffer
         ...
         i32.sub
         i32.load $0
         br_table $~lib/arraybuffer/ArrayBuffer $~lib/string/String $folding-inner0 $folding-inner0 $folding-inner1 $~lib/array/Array<~lib/array/Array<i32>> $bindings/noExportRuntime/NonPlainObject $invalid
        end
        return
       end
       return
