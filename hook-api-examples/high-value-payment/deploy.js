...
const main = async () => {
    const binary = fs.readFileSync('high-value-payment.wasm');
	...
	Hooks: [
		...
		Hook: {
		    ...
		    HookNamespace: 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
		    HookApiVersion: 0,
		    Flags: 1,
		    HookParameters: [
			{
				...
				HookParameterValue: '00E1F505' // 100000000 Little-Endian
			    }
			}
		    ]
		}
